...
public interface FtUserMapper extends BaseMapper<FtUser> {
    ...
    Page<com.asugar.ftwaterdelivery.controller.response.UserResponse> selectPage(@Param("page") IPage<com.asugar.ftwaterdelivery.controller.response.UserResponse> page,
