...
import com.ruoyi.web.dao.FtOrderMapper;
import com.ruoyi.web.entity.FtOrder;
import com.ruoyi.web.service.FtOrderService;
...
public class FtOrderServiceImpl extends BaseMapperImpl<FtOrder, OrderResponse, OrderRequest, FtOrderMapper> implements FtOrderService {
    ...
    @Autowired
    private com.asugar.ftwaterdelivery.controller.websocket.OrderWebSocket orderWebSocket;
